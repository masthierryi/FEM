...
data(inp).BC = [ 1      0 0 ;  
                 lt+1   0 0 ];
%}
%% testando stepped v4 com o do davi
%{    
    % 7850, 205e9, 0.3,   0.01, 0.0250, 2,    0.5, 50; % teste davik
    % 7850, 205e9, 0.3,   0.01, 0.0375, 2,    0.5, 50;  

    % 2710.3, 68.73e9, 0.3,   0.020002, 0.05, 1,   0.032122, 10; % ze
%}
